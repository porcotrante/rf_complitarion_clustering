...
const BANKNOTE_CONFIG: (&str, usize, usize, bool) = ("banknote", 4, 2, false);
const MAGIC_CONFIG: (&str, usize, usize, bool) = ("magic", 10, 2, false);
const ECOLI_CONFIG: (&str, usize, usize, bool) = ("ecoli", 7, 5, false);
const GLASS2_CONFIG: (&str, usize, usize, bool) = ("glass2", 9, 2, false);
const IONOSPHERE_CONFIG: (&str, usize, usize, bool) = ("ionosphere", 34, 2, false);
const IRIS_CONFIG: (&str, usize, usize, bool) = ("iris", 4, 3, false);
const SEGMENTATION_CONFIG: (&str, usize, usize, bool) = ("segmentation", 19, 7, false);
const SHUTTLE_CONFIG: (&str, usize, usize, bool) = ("shuttle", 7, 7, false);
const HEART2_CONFIG: (&str, usize, usize, bool) = ("heart2", 22, 2, false);
const ADULT_CONFIG: (&str, usize, usize, bool) = ("adult", 107, 2, false);
const MUSHROOM_CONFIG: (&str, usize, usize, bool) = ("mushroom", 111, 2, false);
const DEFAULT_CREDIT_CONFIG: (&str, usize, usize, bool) = ("default-credit", 32, 2, false); // Default dataset for credit card fraud detection

// --- Benchmarking Configuration ---
pub const CHOSEN_CONFIG: (&str, usize, usize, bool) = SHUTTLE_CONFIG; // Change this to switch datasets
...
pub const NUM_SEEDS_TO_RUN: u32 = 5; // Number of seeds to run, matching train.py
